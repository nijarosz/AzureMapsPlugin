...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'azure_maps_plugin_welcome_message.ui'))


class AzureMapsWelcomeMessage(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, iface, parent=None):
        """Constructor."""
        super(AzureMapsWelcomeMessage, self).__init__(parent)
